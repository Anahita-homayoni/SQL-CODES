can you help me to to rewrte below code that i have in my github repository to shows in a way that help ful and teaching if any other people come to my github can understand what is it:# SQL-CODES
